...
$("#banner-explore-more").click(function () {
  ...
  textSpan.text(
    textSpan.text().trim() === "Explore More" ? "Show Less" : "Explore More",
  );
});
...
$(".learn-more").click(function (e) {
  ...
  const imgPath = "/wp-content/themes/synergy-theme/assets/img/aroow-blue.svg";

  if ($p.hasClass("expanded")) {
    $this.html(`Show Less <img src="${imgPath}" />`);
  } else {
    $this.html(`Learn More <img src="${imgPath}" />`);
  }
});
